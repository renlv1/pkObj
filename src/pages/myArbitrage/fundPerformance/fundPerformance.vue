  ...
  <div class="achievement">
      ...
      <div class="ord-w">
        <div class="wrap-web">
          <!--<div class="left-content">-->
            ...
            <!--<div class="profit">-->
              ...
              <!--<div class="go-next revenue-record" @click="$router.push({path: '/profitLog'})">-->
                ...
                <!--<div class="turn-next"><img src="../../../assets/images/common/row-13-8.svg"/></div>-->
              <!--</div>-->
              <!--<div class="go-next revenue-record" @click="$router.push({path: '/accumulativePerformance'})">-->
          ...
          <div class="right-content">
            <div class="right-title"><span>{{$t('achievement.text01')}}</span></div>
            ...
            <div class="table-wrap">
              <div class="table-title">
                ...
                <div style="width: 21%">{{$t('achievement.text01')}}</div>
    ...
    <div class="achievement-mobile">
      <div class="head">
        ...
        <div class="title">{{$t('achievement.text01')}}</div>
      </div>
      <div class="de-c">
...
export default {
  ...
  methods: {
    ...
    getPerformanceLog (page) {
      this.$http.post(`${this.$api}/accumulate/accumulateAccount?pageIndex=${page}&pageSize=10&type=2`).then((res) => {
        if (res.data.success === true) {
          this.isLoadMore = false
          this.listData = res.data.data.list
          this.personalAmount = res.data.data.group
